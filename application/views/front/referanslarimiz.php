    ...
    <div class="container mb-90 mt-200">
      <div class="text-center mb-70">
        <h3 class="title-lines-dotted font-color">
          ...
          <span class="text">REFERANSLARIMIZ</span>
          <span class="line"></span>
        </h3>
      </div>
    </div>
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              <div class="brk-gallery-card" data-brk-library="component__gallery">
                <img  src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?php echo base_url(); echo $info['file']; ?>" alt="alt" class="brk-gallery-card__img lazyload ref-resim">
